if(BUILD_OS_LINUX)
    ...
    ExternalProject_Add(bzip2-shared
        URL https://sourceware.org/pub/bzip2/bzip2-1.0.8.tar.gz
        URL_HASH SHA256=ab5a03176ee106d3f0fa90e381da478ddae405918153cca248e682cd0c4a2269
        # FIXME: On the HAL9000 Linux VM that runs CI jobs do not have "patch" installed.
        PATCH_COMMAND cp ${CMAKE_SOURCE_DIR}/projects/bzip2_Makefile-libbz2_so ./Makefile-libbz2_so
        #PATCH_COMMAND patch bzip2_Makefile-libbz2_so ${CMAKE_SOURCE_DIR}/projects/bzip2_shared.patch
        CONFIGURE_COMMAND ""
