...
if(BUILD_OS_WINDOWS)
    set(arcus_BUILD_STATIC OFF)
else()
    set(arcus_BUILD_STATIC ON)
endif()
...
ExternalProject_Add(Arcus
    ...
    CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_INSTALL_LIBDIR=lib -DBUILD_STATIC=${arcus_BUILD_STATIC} -DBUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_PREFIX_PATH=${CMAKE_INSTALL_PREFIX} -G ${CMAKE_GENERATOR}
)
