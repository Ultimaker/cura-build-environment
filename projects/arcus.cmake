if(BUILD_OS_LINUX)
    set(arcus_cmake_command PATH=${CMAKE_INSTALL_PREFIX}/bin/:$ENV{PATH} LD_LIBRARY_PATH=${CMAKE_INSTALL_PREFIX}/lib/ PYTHONPATH=${CMAKE_INSTALL_PREFIX}/lib/python3/dist-packages/:${CMAKE_INSTALL_PREFIX}/lib/python3.6:${CMAKE_INSTALL_PREFIX}/lib/python3.6/site-packages/ ${CMAKE_COMMAND})
else()
